...
class DeepIRLFC:
    def __init__(self, n_input, lr, n_h1=400, n_h2=300, l2=0.5, name='deep_irl_fc'):
...
def deepMaxEntIRL(feat_map, P_a, gamma, trajs, lr, n_iters, fnid_idx, idx_fnid, gpd_file, restore=True):
    """
    ...
    for iteration in range(n_iters):
        ...
        if iteration % (n_iters/10) == 0:
            ...
            tf.train.Saver().save(nn_r.sess, './model/be/realworld')
        ...
        # # save picture
        # img_utils.rewardVisual(normalize(rewards), idx_fnid, gpd_file, "{} iteration".format(iteration))
        ...
        np.save("./model/be/policy_realworld.npy",policy)
